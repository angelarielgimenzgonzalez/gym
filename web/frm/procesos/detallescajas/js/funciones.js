...
//        },
//        error: function (e) {
//            $("#mensajes").html("No se pudo recuperar los datos de factura.");
//        },
//        complete: function (objeto, exito, error) {
//            if (exito === "success") {
//            }
...
function validarFormulario() {
    ...
    /*if ($("#numero_factura_factura").val().length < 2) {
     valor = false;
     $("#mensajes").html("N° de factura es obligatorio.");
     $("#numero_factura_factura").focus();
     }*/
...
function agregarLinea() {
   ...
   // $("#forma_pago").val("");
    ...
    buscarIdCajaDetalle();
    //siguienteCampo("#horas_detalle_factura", "#botonAgregarLinea", true);
}
function editarLinea(id) {
    ...
    buscarIdCajaDetalle();
    //siguienteCampo("#cantidad_producto_factura", "#botonModificarLinea", true);
}
// facturasproductos
...
function validarFormularioCaja() {
    ...
    if (prov === "0") {
        ...
        if (num === "0") {
            ...
            $("#id_factura").val("");
            $("#id_factura").focus();
            $("#mensajes").html("Factura no puede estar vacio.");
...
function ivagravada(e) {
    ...
    valorc = $("#cantidad_producto_factura").val();
    valorp = $("#precio_factura_producto").val();
...
/*function ivagravada(e) {
    ...
    valor = $("#cantidad_producto_factura").val();
    valor1 = $("#preciototal_factura").val();
    totalg = (valor1 * valor);
...
function validarcantidad() {
    var valor = true;
    if ($("#cantidad_producto_factura").val().trim() === "" || $("#cantidad_producto_factura").val().trim() === "0") {
        valor = false;
        $("#mensajes").html("Cantidad debe ser mayor a 0.");
        $("#cantidad_producto_factura").focus();
    }
...
function pretotal(e) {
    ...
    valor1 = $("#precio_factura_producto").val();
    valor2 = $("#cantidad_producto_factura").val();
    /*valor3 = $("#porcentaje_iva").val();
    valor4 = $("#preciototal_factura").val();*/
    subtotal = valor1 * valor2;
    //totaliva = valor3 * valor4;
    //preciototal = subtotal + totaliva;
    //$("#preciototal_factura").val(preciototal);
    $("#preciototal_factura").val(subtotal);
}
