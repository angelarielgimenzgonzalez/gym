...
function ivagravada(e) {
    ...
    valorc = $("#cantidad_factura").val();
    valorp = $("#precio_actividad").val();
...
function validardetalle() {
    if ($("#id_actividad").val().trim() === "" || $("#id_actividad").val().trim() === "0") {
        valor = false;
...
function vuelto(e) {
    //alert("hola soy vuelto");
    //document.getElementById(e.id).value;
    var valor1, valor2, vuelto, valort, valor3;
    valor1 = $("#total").val();
    valor2 = $("#importe_caja").val();
    valor3 = 11;


    valort = Math.round(valor1 / valor3);
