...
<%
    ...
    /*obj.put("nombre_establecimiento", facturas.getEstablecimiento().getNombre_establecimiento());
    obj.put("ruc_establecimiento", facturas.getEstablecimiento().getRuc_establecimiento());*/
    //obj.put("id_puesto", String.valueOf(facturas.getPuesto().getId_puesto()));
